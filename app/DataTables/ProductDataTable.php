    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $editBtn = "<a href='" . route('admin.products.edit', $query->id) . "' class='btn btn-primary btn-sm'><i class='far fa-edit'></i></a>";
                $deleteBtn = "<a href='" . route('admin.products.destroy', $query->id) . "' class='btn btn-danger btn-sm ml-2 delete-item'><i class='far fa-trash-alt'></i></a>";
                $moreBtn = '<div class="dropdown dropleft d-inline">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: transalate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
            ...
            ->addColumn('thumbnail', function ($query) {
                return '<img src="' . asset($query->thumbnail) . '" width="50px" height="50px">';
            })
            ->addColumn('product_type', function ($query) {
                switch ($query->product_type) {
                    ...
                    case 'best_product':
                        ...
                        break;
                    default:
                        return '<i class="badge badge-dark">Regular Product</i>';
                        break;
                }
            })
            ...
            ->rawColumns(['thumbnail', 'action', 'product_type', 'status'])
            ->setRowId('id');
    }
